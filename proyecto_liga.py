...
def LeerPartidos():
	...
	fichero = open(".\learning_openwebinars\data\liga.csv")
...
def Clasificacion(datos):
	"""Recibe la lista generada con la funciÃ³n anterior y la ordena segÃºn 
	el nÃºmero de puntos."""
...
def impClasificacion(liga):
	"""recibe la lista de diccionarios con losnerado a parir del fichero csv, genera los datos
	 de la clasificaciÃ³n y los imprime por pantalla"""
	datos=InfoEquipos(liga,*Equipos(liga))
	contador=1
	line = '-' * 61
	print(line)
	print("|   â„–    |     Equipo      |   PG   |   PP  |  PE   |Puntos |")
	print(line)
